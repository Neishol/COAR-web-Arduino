...
void loop()
{
 ...
 sensors_event_t event;
    ...
    CO2 = mqs[3]->getPPM();
    CH4 = mqs[1]->getPPMCorrected();
    O3  = mqs[2]->getPPMCorrected();
    ...
    */
    ...
    toSend =  (String)  CO + "&"+ CO2 + "&"+ CH4 + "&" + O3 + "&"+ temp + "&" + humd + "&" + Pressure + "&" + UV; // cambiar el nombre de la variable por algo significativo 
    pCharacteristic->setValue(toSend.c_str());
